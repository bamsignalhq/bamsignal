...
/** Default profile card / avatar photo when member has no approved photo */
export const DEFAULT_PROFILE_COVER = MOMENT_SETS.lagosRooftop[1];

/** Default profile hero backdrop when member has no custom cover (presentation only). */
export const DEFAULT_PROFILE_BACKDROP = "/showcase/backdrop.webp";
