...
export const ENV_REGISTRY = [
  ...
  { name: "ADMIN_SECRET", group: "operations", scope: "runtime", required: "critical", owner: "Security", rotation: "quarterly", envs: ["staging", "production"] },
...
export const ENV_USED_IN = {
  ...
  SENDCHAMP_SENDER: ["server/services/sendchamp.js", "server/config.js"],
  SENDCHAMP_WHATSAPP_SENDER: ["server/services/sendchamp.js"],
  SMS_SENDER_ID: ["server/config.js"],
  SMS_PROVIDER: ["server/config.js"],
  SMS_VERIFICATION_REQUIRED_FOR_MESSAGING: ["server/config.js"],
  SELFIE_VERIFICATION_REQUIRED_FOR_MESSAGING: ["server/config.js"],
  DEFAULT_COUNTRY: ["server/config.js"],
  DEFAULT_PHONE_REGION: ["server/config.js"],
  SUPPORTED_COUNTRIES: ["server/config.js"],
  OTP_LENGTH: ["server/config.js"],
  OTP_EXPIRY_MINUTES: ["server/config.js"],
  OTP_MAX_ATTEMPTS: ["server/config.js"],
  OTP_RESEND_SECONDS: ["server/config.js"],
  ...
  CRON_SECRET: ["server/services/cronAuth.js", "server/services/operationSecrets.js"],
  ADMIN_SECRET: ["server/services/operationSecrets.js", "server/adminAuth.js"],
  DIAGNOSTICS_SECRET: ["server/services/diagnosticsAccess.js", "server/services/operationSecrets.js", "certification/production-smoke/config.mjs"],
