...
export const LazyBamSignalInstituteGovernancePage = lazy(() =>
  import("../pages/bam-signal-institute/BamSignalInstituteGovernancePage").then((module) => ({
    default: module.BamSignalInstituteGovernancePage
  }))
);
