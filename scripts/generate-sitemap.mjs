...
const staticPaths = ["", "/blog", "/signal-concierge", ...signalEventsPaths, ...foundationPaths, ...institutePaths, ...LEGAL_STATIC_PATHS, ...SEO_HUB_PATHS, ...SEO_DETAIL_PATHS, ...nigeriaPaths];
