...
export const LazyPerformanceCertificationDashboard = lazy(() =>
  import("./performanceCertification/PerformanceCertificationDashboard").then((module) => ({
    default: module.PerformanceCertificationDashboard
  }))
);
export const LazySecurityCertificationDashboard = lazy(() =>
  import("./securityCertification/SecurityCertificationDashboard").then((module) => ({
...
export const LazyDependencyCertificationDashboard = lazy(() =>
  import("./dependencyCertification/DependencyCertificationDashboard").then((module) => ({
