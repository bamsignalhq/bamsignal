...
import {
  ...
  LazyDependencyCertificationDashboard,
  LazyAccessibilityCertificationDashboard,
  LazyDriftCertificationDashboard,
  LazyRcCertificationDashboard,
  LazyFounderCertificationDashboard,
...
export function AdminHubPage({ onLogout }: AdminHubPageProps) {
  ...
  return (
    ...
    <div className="admin-console">
      ...
      <AdminLazyTab active={tab === "launchcertification"}>
        <LazyLaunchCertificationDashboard />
      </AdminLazyTab>
      <AdminLazyTab active={tab === "performancecertification"}>
        <LazyPerformanceCertificationDashboard />
      </AdminLazyTab>
      ...
      <AdminLazyTab active={tab === "dependencycertification"}>
        <LazyDependencyCertificationDashboard />
      </AdminLazyTab>
      <AdminLazyTab active={tab === "accessibilitycertification"}>
        <LazyAccessibilityCertificationDashboard />
      </AdminLazyTab>
      <AdminLazyTab active={tab === "driftcertification"}>
        <LazyDriftCertificationDashboard />
      </AdminLazyTab>
      <AdminLazyTab active={tab === "rccertification"}>
        <LazyRcCertificationDashboard />
      </AdminLazyTab>
      <AdminLazyTab active={tab === "foundercertification"}>
        <LazyFounderCertificationDashboard />
      </AdminLazyTab>
      <AdminLazyTab active={tab === "enterprisecleanup"}>
        <LazyEnterpriseCodebaseCleanupDashboard />
      </AdminLazyTab>
      <AdminLazyTab active={tab === "productionenvironment"}>
        <LazyProductionEnvironmentDashboard />
      </AdminLazyTab>
      <AdminLazyTab active={tab === "launchinfrastructure"}>
        <LazyLaunchInfrastructureDashboard />
      </AdminLazyTab>
      <AdminLazyTab active={tab === "founderacceptance"}>
        <LazyFounderAcceptanceDashboard />
      </AdminLazyTab>
      <AdminLazyTab active={tab === "observability"}>
        <LazyProductionObservabilityPage />
      </AdminLazyTab>
      ...
      <AdminLazyTab active={tab === "abuseprotection"}>
        <LazyAbuseProtectionCenterPage />
      </AdminLazyTab>
      <AdminLazyTab active={tab === "search"}>
        <LazySearchCenterPage />
      </AdminLazyTab>
      <AdminLazyTab active={tab === "disasterrecovery"}>
        <LazyDisasterRecoveryCenterPage />
      </AdminLazyTab>
      ...
      <AdminLazyTab active={tab === "securityops"}>
        <LazySecurityOperationsCenterPage />
      </AdminLazyTab>
      <AdminLazyTab active={tab === "enterpriseapi"}>
        <LazyEnterpriseApiCenterPage />
      </AdminLazyTab>
