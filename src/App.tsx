...
import {
  ...
  LazyBamSignalInstituteReflectionRoomPage,
  LazyBamSignalInstituteFamilyTablePage,
  LazyBamSignalInstituteBamSignalStudioPage,
  LazyBamSignalInstituteLegacyHallPage,
  LazyBamSignalInstituteLegacyGardenPage,
  LazyBamSignalInstituteRelationshipConnectHousePage,
  LazyBamSignalInstituteBallroomPage,
  LazyBamSignalInstituteHouseMembershipPage,
  LazyBamSignalInstituteHouseResidenciesPage,
  LazyBamSignalInstituteHouseFoundationPage,
...
export function App() {
  ...
  const MEMBER_BUNDLE_HYDRATE_FAILSAFE_MS = 8_000;
    ...
    (
      ...
      const finish = (result?: MemberSessionBootstrapResult) => {
        ...
        if (result) {
          ...
          } else if (result.nextRoute === "onboarding" && isMemberAppPath() && !isOnboardingPath()) {
      ...
      hydrateMemberAppInBackground(
        profile,
        {
          ...
          skipOnboardingStatus: options?.skipOnboardingStatus ?? true
        },
        (bootstrap) => {
          finish(bootstrap);
        }
  ...
  }, [applyGoToAppResult, clearMemberSessionReady, markMemberSessionReady, scheduleMemberBundleHydration]);

  useEffect(() => {
    if (memberAccessReady) {
      markStartupFirstPaint({ route: memberPathname, tab });
    }
  }, [memberAccessReady, memberPathname, tab]);
  useEffect(() => {
          ...
          .then((sessionResult) => {
            ...
            if (onMemberSurface) {
              ...
              if (sessionResult.route === "home") {
                scheduleMemberBundleHydration(profile, { skipOnboardingStatus: true });
              } else {
                setProfileComplete(false);
              }
            }
  ...
  if (bamSignalInstituteRoute) {
    ...
    return (
      <Suspense fallback={<LazyRouteFallback subtitle="Loading BamSignal Institute…" />}>
        ...
        ) : bamSignalInstituteRoute === "reflectionRoom" ? (
          <LazyBamSignalInstituteReflectionRoomPage {...instituteShellProps} />
        ) : bamSignalInstituteRoute === "familyTable" ? (
          <LazyBamSignalInstituteFamilyTablePage {...instituteShellProps} />
        ) : bamSignalInstituteRoute === "bamSignalStudio" ? (
          <LazyBamSignalInstituteBamSignalStudioPage {...instituteShellProps} />
        ) : bamSignalInstituteRoute === "legacyHall" ? (
          <LazyBamSignalInstituteLegacyHallPage {...instituteShellProps} />
        ) : bamSignalInstituteRoute === "legacyGarden" ? (
          <LazyBamSignalInstituteLegacyGardenPage {...instituteShellProps} />
        ) : bamSignalInstituteRoute === "relationshipConnectHouse" ? (
          <LazyBamSignalInstituteRelationshipConnectHousePage {...instituteShellProps} />
        ) : bamSignalInstituteRoute === "ballroom" ? (
          <LazyBamSignalInstituteBallroomPage {...instituteShellProps} />
        ) : bamSignalInstituteRoute === "houseMembership" ? (
          <LazyBamSignalInstituteHouseMembershipPage {...instituteShellProps} />
        ) : bamSignalInstituteRoute === "houseResidencies" ? (
          <LazyBamSignalInstituteHouseResidenciesPage {...instituteShellProps} />
        ) : bamSignalInstituteRoute === "houseFoundation" ? (
          <LazyBamSignalInstituteHouseFoundationPage {...instituteShellProps} />
        ) : bamSignalInstituteRoute === "houseMuseum" ? (
          <LazyBamSignalInstituteHouseMuseumPage {...instituteShellProps} />
        ) : bamSignalInstituteRoute === "houseAcademy" ? (
        ...
        ) : bamSignalInstituteRoute === "governance" ? (
          <LazyBamSignalInstituteGovernancePage {...instituteShellProps} />
        ) : (
          <LazyBamSignalInstituteLandingPage {...instituteShellProps} />
        )}
      </Suspense>
