...
create table if not exists public.passport_trust_signals (
  id uuid primary key default gen_random_uuid(),
  signal_id text not null,
  passport_id text not null,
  contributor_id text not null references public.passport_signal_contributors (contributor_id),
...
create table if not exists public.passport_signal_validation_reports (
  id uuid primary key default gen_random_uuid(),
  signal_row_id uuid null references public.passport_trust_signals (id) on delete set null,
  signal_id text null,
  contributor_id text not null,
  passport_id text not null,
...
create table if not exists public.passport_signal_provenance (
  id uuid primary key default gen_random_uuid(),
...
create table if not exists public.passport_signal_events (
  id uuid primary key default gen_random_uuid(),
