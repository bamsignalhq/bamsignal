          ...
          <div className="institute-header__inner">
            ...
            <nav className="institute-header__nav" aria-label="BamSignal Institute">
              ...
              <button
                type="button"
                className="institute-header__link"
                onClick={() => go("relationshipConnectHouse")}
              >
                Connect House
              </button>
              <button
