...
import authSessionsHandler from "../api/auth/sessions.js";
import authAccountHandler from "../api/auth/account.js";
import financeBillingHandler from "../api/finance/billing.js";
...
import conciergeOperationsHandler from "./routes/conciergeOperations.js";
import conciergeMemberHandler from "./routes/conciergeMember.js";
...
import adminDiscoverCommerceHandler from "../api/admin/discover-commerce.js";
import adminDiscreetMembershipHandler from "../api/admin/discreet-membership.js";
...
export function createApp(options = {}) {
  ...
  mountHandler(app, "post", "/api/auth/sessions", authSessionsHandler);
  mountHandler(app, "post", "/api/auth/account", authAccountHandler);
  mountHandler(app, "post", "/api/finance/billing", financeBillingHandler);
  ...
  mountHandler(app, "post", "/api/concierge-operations", conciergeOperationsHandler);
  mountHandler(app, "post", "/api/concierge-member", conciergeMemberHandler);
  ...
  mountHandler(app, "post", "/api/admin/discover-commerce", adminDiscoverCommerceHandler);
  mountHandler(app, "post", "/api/admin/discreet-membership", adminDiscreetMembershipHandler);
  ...
  mountHandler(app, "post", "/api/passport/signals", passportSignalsHandler);
  mountHandler(app, "get", "/api/passport/signals/:signalId", passportSignalsHandler);
  mountHandler(app, "get", "/api/passport/passports/:passportId/signals", passportSignalsHandler);
