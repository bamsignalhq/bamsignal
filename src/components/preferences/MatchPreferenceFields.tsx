...
export function MatchPreferenceFields({
  ...
  onStateOfOriginChange: _onStateOfOriginChange,
  statesOfOrigin,
  ...
  onGenotypesChange,
  genotype: _genotype,
  onGenotypeChange: _onGenotypeChange,
  occupation: _occupation,
  onOccupationChange: _onOccupationChange,
  hasKidsOption: _hasKidsOption,
  onHasKidsOptionChange: _onHasKidsOptionChange,
  hasKids,
  onHasKidsChange,
  wantsKidsOption: _wantsKidsOption,
  onWantsKidsOptionChange: _onWantsKidsOptionChange,
  wantsKids,
  onWantsKidsChange,
  bodyType: _bodyType,
  onBodyTypeChange: _onBodyTypeChange,
  bodyTypes,
  onBodyTypesChange,
