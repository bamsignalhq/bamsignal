...
type ConsultantView = "members" | "introductions" | "follow-up" | "consultants" | "performance" | "operations" | "archive" | "legacy" | "families" | "years" | "founders" | "stories";
    ...
    <div className="concierge-consultant-dashboard">
      <header className="concierge-consultant-dashboard__head">
        ...
        <div className="concierge-consultant-dashboard__tabs">
          ...
          <button
            type="button"
            className={`concierge-consultant-dashboard__tab${view === "operations" ? " is-active" : ""}`}
          ...
          <button
            type="button"
            className={`concierge-consultant-dashboard__tab${view === "founders" ? " is-active" : ""}`}
      ...
      {view === "founders" ? <FoundersWallPage /> : null}
