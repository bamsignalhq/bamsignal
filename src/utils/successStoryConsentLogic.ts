...
import type {
  SuccessStoryConsentHistoryEntry,
  SuccessStoryConsentRecord,
  SuccessStoryConsentPermissions
} from "../types/conciergeSuccessStoryConsent";
...
export function bothPartiesApproved(consent: SuccessStoryConsentRecord): boolean {
  return consent.partyApprovals.memberA.approved && consent.partyApprovals.memberB.approved;
}

export function canPublishSuccessStory(consent: SuccessStoryConsentRecord | null | undefined): boolean {
...
export function assertConsentHistoryAppendOnly(
  previous: SuccessStoryConsentRecord,
  next: SuccessStoryConsentRecord
): void {
...
function appendHistory(
  ...
  entry: SuccessStoryConsentHistoryEntry
): SuccessStoryConsentRecord {
  return {
    ...consent,
...
export function applyPartyApproval(
  consent: SuccessStoryConsentRecord,
  ...
  const next: SuccessStoryConsentRecord = {
    ...consent,
    withdrawn: false,
...
export function updateConsentPermissions(
  consent: SuccessStoryConsentRecord,
...
export function withdrawSuccessStoryConsent(
  consent: SuccessStoryConsentRecord,
...
export function getPartyApprovalStatus(consent: SuccessStoryConsentRecord) {
  return {
