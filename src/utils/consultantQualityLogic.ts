import { QUALITY_METRICS, QUALITY_RATING_SCORES } from "../constants/consultantQuality";
...
export function listQualityReviews(): QualityReviewRecord[] {
  return [...CONSULTANT_QUALITY_SEED];
}
...
export function buildQualityMetrics(reviews: QualityReviewRecord[]) {
