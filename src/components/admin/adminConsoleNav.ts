...
export const ADMIN_NAV_SECTIONS: AdminNavSection[] = [
  {
    ...
    items: [
      ...
      {
        id: "performancecertification",
        label: "Perf Cert",
        keywords: ["performance", "lcp", "cls", "bundle", "latency", "regression", "certify", "speed"]
      },
      {
        id: "securitycertification",
        label: "Sec Cert",
        keywords: ["security", "owasp", "secrets", "rls", "jwt", "csrf", "xss", "certify", "audit"]
      },
      {
        id: "reliabilitycertification",
        label: "Rel Cert",
        keywords: ["reliability", "failure", "recovery", "degradation", "retry", "fallback", "outage", "certify"]
      },
      {
        id: "foundercertification",
        label: "Founder Cert",
        keywords: ["founder", "launch", "go", "no-go", "board", "release", "certify", "master"]
      },
      {
...
export const HARD_TAB_TITLES: Record<HardTab, string> = {
  ...
  performancecertification: "Perf Cert",
