      ...
      <header className="bi-page__hero institute-glass">
        ...
        <div className="bi-page__actions">
          ...
          <button
            type="button"
            className="bi-page__btn"
            onClick={() => navigateToPath(bamSignalInstitutePathForRoute("houseLibrary"))}
          >
            Library
          </button>
          <button
            type="button"
            className="bi-page__btn"
            onClick={() => navigateToPath(bamSignalInstitutePathForRoute("reflectionRoom"))}
          >
            Reflection
          </button>
          <button
          ...
          <button
            type="button"
            className="bi-page__btn"
            onClick={() => navigateToPath(bamSignalInstitutePathForRoute("bamSignalStudio"))}
          >
            Studio
          </button>
          <button
          ...
          <button
            type="button"
            className="bi-page__btn"
            onClick={() => navigateToPath(bamSignalInstitutePathForRoute("legacyGarden"))}
          >
            Garden
          </button>
          <button
            type="button"
            className="bi-page__btn"
            onClick={() => navigateToPath(bamSignalInstitutePathForRoute("relationshipConnectHouse"))}
          >
            Connect House
          </button>
          <button
            type="button"
            className="bi-page__btn"
            onClick={() => navigateToPath(bamSignalInstitutePathForRoute("ballroom"))}
          >
            Ballroom
          </button>
          <button
            type="button"
            className="bi-page__btn"
            onClick={() => navigateToPath(bamSignalInstitutePathForRoute("houseMembership"))}
          >
            Membership
          </button>
          <button
            type="button"
            className="bi-page__btn"
            onClick={() => navigateToPath(bamSignalInstitutePathForRoute("houseResidencies"))}
          >
            Residencies
          </button>
          <button
            type="button"
            className="bi-page__btn"
            onClick={() => navigateToPath(bamSignalInstitutePathForRoute("houseFoundation"))}
          >
            Foundation
          </button>
          <button
            type="button"
            className="bi-page__btn"
            onClick={() => navigateToPath(bamSignalInstitutePathForRoute("houseMuseum"))}
          >
            Museum
          </button>
          <button
            type="button"
            className="bi-page__btn"
            onClick={() => navigateToPath(bamSignalInstitutePathForRoute("houseAcademy"))}
          >
            Academy
          </button>
          <button
            type="button"
            className="bi-page__btn"
            onClick={() => navigateToPath(bamSignalInstitutePathForRoute("houseInstitute"))}
          >
            Institute
          </button>
          <button
