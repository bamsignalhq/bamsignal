...
export const BAMSIGNAL_INSTITUTE_ROUTES = {
  ...
  bamSignalHouse: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/bamsignal-house`,
  houseExperiences: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/house-experiences`,
  greatRoom: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/great-room`,
  ...
  legacyGarden: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/legacy-garden`,
  relationshipConnectHouse: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/relationship-connect-house`,
  ballroom: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/ballroom`,
  houseMembership: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/house-membership`,
  houseResidencies: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/house-residencies`,
  houseFoundation: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/house-foundation`,
  houseMuseum: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/house-museum`,
  houseAcademy: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/house-academy`,
  houseInstitute: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/house-institute`,
  centuryRoom: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/century-room`,
  governance: `${BAMSIGNAL_INSTITUTE_BASE_PATH}/governance`
} as const;
